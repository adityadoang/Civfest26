...
const newLogoBlock = `<a href="/index.html" class="logo" style="display: flex; align-items: center; gap: 0.75rem; text-decoration: none;">
...
for (const file of files) {
  ...
  // We are matching the previous layout which started with `<a href="/index.html" class="logo" style="display: flex; flex-direction: column; line-height: 1.2; text-decoration: none;">`
  // and ended with `</a>`
  content = content.replace(/<a href="\/index\.html" class="logo" style="display: flex; flex-direction: column; line-height: 1\.2; text-decoration: none;">.*?<\/a>/s, newLogoBlock);
